...
const albumStore={}
function album_store(artist, title){
    console.log(make_album(artist, title))
    albumStore["firstAlbum"]=make_album(artist, title)
    console.log(albumStore["firstAlbum"])
}


album_store("Junaid jamshed","Sary siapy pyar dy")
